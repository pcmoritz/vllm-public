...
def fused_moe_kernel1(
    ...
    tl.store(c_ptrs, acc1 * tl.sigmoid(acc2.to(tl.float32)).to(compute_type), mask=c_mask)
...
def fused_moe(hidden_states: torch.Tensor,
    ...
    invoke_fused_moe_kernel1(hidden_states, w1, intermediate_cache1,
    ...
    invoke_fused_moe_kernel2(intermediate_cache2, w2, intermediate_cache3,
                            topk_weights, topk_ids, sorted_token_ids,
