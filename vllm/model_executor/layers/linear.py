...
class ColumnParallelLinear(LinearBase):
    ...
    def forward(self, input_, out_dtype=None):
        ...
        # Matrix multiply.
        assert self.quant_method is not None
        output_parallel = self.quant_method.apply(self, input_, bias, out_dtype=out_dtype)
...
class RowParallelLinear(LinearBase):
    ...
    def forward(self, input_, out_dtype=None):
        ...
        # Matrix multiply.
        assert self.quant_method is not None
        output_parallel = self.quant_method.apply(self, input_parallel, out_dtype=out_dtype)
